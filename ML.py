...
def a_star_solve(initial):
    ...
    heapq.heappush(pq, (h, 0, initial.copy()))
    steps = []
...
class NQueensGUI:
    ...
    def create_widgets(self):
        ...
        # Bind to update scrollregion dynamically
        ...
        tk.Entry(frame_input, textvariable=self.n_var, width=5, font=("Arial", 10)).grid(row=0, column=1, padx=5,
                                                                                         pady=5)

        tk.Label(frame_input, text="Initial Positions (0-based, space-separated):", font=("Arial", 10)).grid(row=0,
                                                                                                             column=2,
                                                                                                             padx=5,
                                                                                                             pady=5)
        tk.Entry(frame_input, textvariable=self.positions_var, width=30, font=("Arial", 10)).grid(row=0, column=3,
                                                                                                  padx=5, pady=5)
        ...
        self.info_text = tk.Text(frame_info, height=8, width=115, font=("Arial", 10),
